...
public class el2 extends enemyTest {

    /********STATS*********/
    public static int MAX_HP = 36;
    public static int HP = 36;
    public static int SHIELDS = 25;
    public static int attack_damage = 4;
    ...
    public static Texture enemySprite = new Texture("assets/Pictures/Sprites/Enemies/enemy4.png");
