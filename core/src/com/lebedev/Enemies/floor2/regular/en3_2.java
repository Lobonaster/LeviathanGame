...
public class en3_2 extends enemyTest {
    ...
    public static int make_move() {
        ...
        switch (pattern) {
            case 1:
                enemyTest.roll = 1;
                Verg.manage_HP(-5 - enemyTest.strength);
                enemyTest.attack_damage = 18;
                moveType = 1;
                break;
            case 2:
                enemyTest.HP += 18;
                ...
                Verg.manage_HP(-18 - enemyTest.strength);
                enemyTest.attack_damage = 5;
                moveType = 1;
                break;
        }
